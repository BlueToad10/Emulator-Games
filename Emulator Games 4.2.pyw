...
FPS=60
PAGE=NUMBER=0
nesNum=snesNum=n64Num=gbNum=gbaNum=gcwiiNum=0
Branch = "System"
MaxNum=6
gamesNum = 0
systemNum = 0
...
pygame.init()
pygame.mixer.init()
pygame.display.set_caption("Emulator Games 4.2")
...
class right(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.MaxNum = 0
    def update(self):
        global PAGE, NUMBER, Branch, systemNum
        if Branch == "system":
...
def controls():
    global NUMBER, Branch, nesNum, snesNum, n64Num, gbNum, gbaNum, MaxNum, PAGE, gamesNum, systemNum
...
def titleScreen():
    ...
    while True:
        ...
        DrawText("4.2", "moon_get-Heavy.ttf", 32, (255, 255, 255), windowSurface, 325, 150, 720, 480)
...
def gameSelect():
    ...
    while True:
        ...
        if Branch == "nes":
            ...
            DrawText(gcWii[NUMBER], "moon_get-Heavy.ttf", 32, (255, 255, 255), windowSurface, 50, 150, 720, 480)
        mainLoop()
