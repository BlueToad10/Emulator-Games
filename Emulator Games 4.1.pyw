...
pygame.init()
pygame.mixer.init()
pygame.display.set_caption("Emulator Games 4.1")
...
system = ["Nes", "Snes", "N64", "Gb", "Gba", "GameCube and Wii"]
nes = []
snes = []
n64 = []
gb = []
...
def titleScreen():
    ...
    while True:
        ...
        DrawText("4.1", "moon_get-Heavy.ttf", 32, (255, 255, 255), windowSurface, 325, 150, 720, 480)
